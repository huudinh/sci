<style>
.header_dls_1_0_0{position:fixed;top:0;left:0;width:100%;z-index:20;font-family:var(--primary-font);background:rgba(0,0,0,.8);border-bottom:1px solid #fff;height:88px}
...
.header_dls_1_0_0__item{padding:0 2.2vw}
...
.header_dls_1_0_0__dropdown{transition:all .2s linear;display:none;position:absolute;top:84px;width:250px;background:#fff;border-bottom-left-radius:10px;border-bottom-right-radius:10px;border:1px solid rgba(0,0,0,.15);box-shadow:0 0 2px rgba(0,0,0,.2);padding:20px}
.header_dls_1_0_0__dropdownCate{width:100%;margin-right:20px}
.header_dls_1_0_0__dropdownCate:last-child{margin-right:0}
.header_dls_1_0_0__dropdownTitle{font-size:14px;text-transform:uppercase;color:#461396;font-weight:600;margin-bottom:5px}
.header_dls_1_0_0__dropdown ul{list-style:none;padding:0;margin:0;font-size:12px}
.header_dls_1_0_0__dropdown ul li{border-bottom:1px solid #f1f1f1;padding-bottom:8px;margin-bottom:7px}
.header_dls_1_0_0__dropdown ul li:hover a{color:#0056a4}
.header_dls_1_0_0__item:hover .header_dls_1_0_0__dropdown{display:flex}
...
.header_dls_1_0_0__dropdown{width:100%;display:none;position:unset;padding:0;box-shadow:unset;border:none;margin:10px 0 0;border-radius:0}
.header_dls_1_0_0__dropdownCate{width:100%;padding:10px 0 10px 15px;margin:0}
.header_dls_1_0_0__dropdownCate ul li:hover a{color:#000}
.header_dls_1_0_0__dropdownCate ul li a{color:#0056a4}
}
