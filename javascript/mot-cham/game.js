    ...
    image.onload = () => {
      ...
      for (let i = 0; i < this.gridSize; i++) {
        for (let j = 0; j < this.gridSize; j++) {
          ...
          // ctx.drawImage(image, j * pieceSize, i * pieceSize, pieceSize, pieceSize);
      ...
      this.riddle.forEach((num, idx) => {
        let ele, eleImg, eleText;
        if (num === this.gridSize * this.gridSize - 1) {
          ele = document.createElement("div");
        } else {
          ele = document.createElement("div");
          eleImg = document.createElement("img");
          eleText = document.createElement("span");
          eleText.classList.add("text");
          ele.classList.add("piece");
          ele.classList.add("p"+num);
          eleImg.src = this.pieceUrls[num];
          eleText.innerHTML = num+1;
